...
> import Web.Fn
> import Network.Wai (Response, Application, responseLBS)
...
> coffeeHandler ctxt = do
>   putStrLn "Hello"
>   return (Just $ responseLBS status418 [] "short and stout")
